...
export interface IComponent
{
	...
	init(go: Phaser.GameObjects.GameObject, components: ComponentService) : any
...
{
	addComponent(go: Phaser.GameObjects.GameObject, component: IComponent) : any 
	findComponent<ComponentType>(go: Phaser.GameObjects.GameObject, componentType: Constructor<ComponentType>) : any 
	destroy() : any
